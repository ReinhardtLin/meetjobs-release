...
- 帳戶設定加入了修改密碼功能，透過 Facebook 登入的使用者也能夠在此處設定新的密碼。
...
- 修正了從 Word 或 Page 複製文字到編輯器的異常。

- 全新的企業成員管理介面，擁有者現在可自由轉移擁有者權限或移除成員。

- 當您的職缺超過30天未更新，將在職缺列表上有明顯的黃色提示。

---

# Meet.jobs Release Note 29th April 2019

## 一般用戶

- Meet.jobs 專欄現在已經提供了相關職缺及相關企業的連結。

- 求職者透過 Meet.jobs 連接至外部求職網站，現在起可以在 「我的應徵」 中回報順利錄取，領取 Meet.jobs 額外提供的 US $100 獎金。
...
- 您可透過 「更新全部職缺」 的按鈕，一次更新所有張貼中的職缺。

- 超過60天沒有任何動作的職缺，將會被系統自動關閉。系統也會在第45天提醒您要更新職缺。
...
- 全新的 Meet.jobs 專欄已上線，將陸續提供更多優質的內容。
...
- 您現在可以輸入任何地址，來取得該地點附近最新的職缺資訊，並提供熱門關鍵字。
...
- 透過新的徵才企業註冊流程，您現在可以先開始使用徵才服務，再讓 Meet.jobs 聯繫您進行合約簽訂。

- 提供了PDF版本的徵才企業合約下載。

- 新增徵才企業資訊時，有了新的完成度百分比提示。

---

# Meet.jobs Release Note 4th March 2019
